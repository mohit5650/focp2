...
public class NameValidator{
	public boolean nameValidator(String filename, String filetype){
		...
		PropertyConfigurator.configure("C:\\Users\\HP\\Desktop\\Structure\\csvtojson\\configs\\logger");
		try{	
			input = new FileInputStream("C:\\Users\\HP\\Desktop\\Structure\\csvtojson\\configs\\logger\\exceptions.properties");
			prop.load(input);
